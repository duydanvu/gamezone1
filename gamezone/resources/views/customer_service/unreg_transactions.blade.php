        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Giao Dịch Hủy</li>
                </ol>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        ...
        $('#export_data').click(function () {
            ...
            var url = "{{ route ('export_unreg_to_file_csv',['datetime' => ":datetime"])}}";
        ...
        $(document).ready(function(){
            $('#fillter_date').click(function () {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{route('search_date_time_unreg_tran')}}',
                    data:dt,
